...
namespace TestPlatform
{
    class LaunchingTest
    {
        ...
        public static void Main(string[] arg)
        {
            ...
            //Console.WriteLine("Поиск всех целых ключей в БД PolarDB 1000 раз. Время = {0}мс",       polar.FindAll(1000,"id_author", out count));
            //Console.WriteLine("Поиск всех строковых ключей в БД PolarDB 1000 раз. Время = {0}мс",   polar.FindAll(1000,"title", out count));
