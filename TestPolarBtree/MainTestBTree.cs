...
namespace TestPolarBtree
{
    class MainTest
    {
        static void Main(string[] args)
        {
            ...
            LoadTree(btree, 1000000);

            //WriteTreeInFile(btree, "../../Results/Tree.txt");

            SearchKey(btree, 1000000);
        ...
        private static void WriteTreeInFile(BTree btree, string path)
        {
        ...
        private static void SearchRandomKey1000(BTree btree)
        {
            ...
            for (int i = 0; i < 1000; ++i)
                btree.Search(btree.Root, rnd.Next(1000000)); 
